...
TEAM_ABBREVS = {
    # ── Europa — Fútbol ──
    'Real Madrid': 'RMA', 'Atletico Madrid': 'ATM', 'Barcelona': 'FCB',
    ...
    'Internazionale': 'INT', 'AC Milan': 'ACM', 'Paris': 'PSG',
    ...
    # ── Selecciones (Mundial 2026 + principales) ──
    ...
    'Bosnia and Herzegovina': 'BIH', 'USA': 'USA', 'Paraguay': 'PAR',
    'Qatar': 'QAT', 'Switzerland': 'SUI', 'Morocco': 'MAR',
    'Haiti': 'HAI', 'Scotland': 'SCO', 'Australia': 'AUS', 'Turkey': 'TUR',
    'Curacao': 'CUR', 'Netherlands': 'NED', 'Japan': 'JPN',
    'Ivory Coast': 'CIV', 'Ecuador': 'ECU', 'Sweden': 'SWE', 'Tunisia': 'TUN',
    'Cape Verde': 'CPV', 'Belgium': 'BEL', 'Egypt': 'EGY',
    'Saudi Arabia': 'KSA', 'Uruguay': 'URU', 'Iran': 'IRN',
    'New Zealand': 'NZL', 'Senegal': 'SEN', 'Iraq': 'IRQ', 'Norway': 'NOR',
    'Algeria': 'DZA', 'Austria': 'AUT', 'Jordan': 'JOR',
    'DR Congo': 'COD', 'Croatia': 'CRO', 'Ghana': 'GHA', 'Panama': 'PAN',
    'Uzbekistan': 'UZB', 'Colombia': 'COL',
    # ── Sudamérica — Fútbol (nombres largos primero para evitar conflictos) ──
    'Barracas Central': 'BRC', 'Barcelona Sporting': 'BSC',
    'Botafogo Ribeirao': 'BRP', 'Botafogo de Futebol': 'BOT', 'Botafogo': 'BOT',
    'Liverpool Montevideo': 'LIM',
    'Racing Club de Avellaneda': 'RAC', 'Racing Club': 'RAC',
    'River Plate Buenos Aires': 'RIV', 'River Plate': 'RIV',
    'Rosario Central': 'ROC', 'Central Espanol': 'CES', 'Central Cordoba': 'CCO',
    'Independiente Rivadavia': 'IRV', 'Independiente del Valle': 'IDV', 'Independiente': 'IND',
    'Universitario de Vinto': 'UDV', 'Universitario': 'UNV',
    'Palmeiras': 'PAL', 'Flamengo': 'FLA', 'Corinthians': 'COR',
    'Cruzeiro': 'CRU', 'Fluminense': 'FLU',
    'São Paulo': 'SAO', 'Internacional': 'ITP', 'Grêmio': 'GRE',
    'Santos': 'SAN', 'Vasco da Gama': 'VAS', 'Bragantino': 'BGT',
    'Atlético Mineiro': 'CAM', 'Athletico PR': 'CAP',
    'Boca Juniors': 'BOC', 'San Lorenzo': 'SLO', 'Vélez': 'VEL',
    'Talleres': 'TAL', 'Belgrano': 'BLG', 'Tigre': 'TIG',
    'Lanús': 'LAN', 'Banfield': 'BAN', 'Platense': 'PLA',
    'Huracán': 'HUR', 'Colón': 'CLN', 'Unión': 'UNI',
    'Estudiantes': 'EST', 'Defensa y Justicia': 'DYJ',
    'Ind. Rivadavia': 'IRV', 'Ind. del Valle': 'IDV',
    'Olimpia': 'OLI', 'Libertad': 'LIB', 'Junior': 'JUN',
    'Santa Fe': 'STF', 'U. Católica': 'UCA', 'Macará': 'MAC',
    'Penarol': 'PEN', 'Nacional': 'NAC',
    'Leones Del Norte': 'LDN', 'Aurora': 'AUR',
    'Tecnico Universitario': 'TUN',
    'Alianza': 'ALI',
    # ── NHL ──
    'Colorado Avalanche': 'AVS', 'Vegas Golden Knights': 'VGK',
    # ── MLB — cada equipo con abreviación única ──
    ...
    'Nationals': 'WAS', 'Athletics': 'OAK',
    'Rockies': 'CRK', 'Diamondbacks': 'ARI', 'Marlins': 'MIA',
...
TEAM_NAME_ES = {
    ...
    'Senegal': 'Senegal', 'Ghana': 'Ghana', 'Jordan': 'Jordania',
    'Austria': 'Austria', 'Qatar': 'Catar',
